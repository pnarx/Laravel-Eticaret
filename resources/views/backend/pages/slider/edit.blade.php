           ...
           @endif
            <form action="{{$routelink}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      ...
                      <span class="input-group-append">
                        <button class="file-upload-browse btn btn-primary" type="button">Güncelle</button>
                      </span>
                    </div>
                  </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea  class="form-control" id="content" name="content" placeholder="Slider Açıklama" rows="3"> {{!! $slider->content ?? '' !!}}</textarea>
              </div>
              <div class="form-group">
